...
class NexusManager:
    ...
    def process_with_pipeline(self, pipeline_name: str,
    ...
    def chain_pipelines(self, pipeline_names: List[str],
                        data: Any) -> Union[str, Any]:
        result: Any = data
...
if __name__ == "__main__":
    ...
    print(f"Pipeline {p_lines[1]} -> Pipeline "
          f"{p_lines[2]} -> Pipeline {p_lines[3]}")
